    ...
    <div className={tema} style={{display:"flex",height:"100vh"}}>
      ...
      <div className="sidebar">
        <div className="logo-area">
          ...
          <div>
            <div className="logo-text">DR. WELLNESS</div>
            <div className="logo-sub">Area PT</div>
          </div>
        </div>
        ...
        <NavLink to="/nutrizionale" className="nav-link"><i className="ti ti-stethoscope"></i> Visita Nutrizionale</NavLink>
