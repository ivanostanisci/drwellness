  ...
  return (
    <div className={tema} style={{display:"flex",height:"100vh"}}>
      ...
      <div className="sidebar">
        <div className="logo-area" style={{padding:"1rem 1.1rem",display:"flex",alignItems:"center"}}>
          <img src="/logo.jpg" style={{width:"110px",objectFit:"contain",filter:"brightness(0.85)"}}/>
        </div>
        </div>
